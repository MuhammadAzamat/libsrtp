...
//        const byte key[] = { 0x73, 0x3d, 0x2c, 0x20, 0x65, 0x68, 0x65, 0x73,
...
//    };
    ...
    const byte plaintext[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
    ...
    //    const uint8_t output[] = {0x1b, 0x0b, 0xbc, 0x32, 0xce, 0xbc, 0xab,    //    0x42};
    ...
    gost_ctx c;
    gost_init(&c, &Sbox_Default);
    gost_key(&c, key);
    gost_enc(&c, plaintext, ciphertext, sizeof(plaintext) / 8);
    ...
    gost_dec(&c, ciphertext, deciphertext, sizeof(plaintext) / 8);
